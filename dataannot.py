...
file = "3 love 6 computers 2 dogs 4 cats 5 you 6 1 "
pyramid = []
# for char in file:
separator = file.split()
numbers = ' , '.join(x for x in separator if x.isdigit())


numbers_sep = numbers.split(' , ' )
for num in numbers_sep:
    convert_string = ' '.join(numbers_sep) # converting list into string
    print(convert_string)
    pyramid = convert_string.append

    # nums_split = convert_string.split( )
#     # for numbs in nums_int:
